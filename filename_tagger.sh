...
# +----------------------------------------+
#
VERSION="2020-11-22 22:58"
THIS_FILE="filename_tagger.sh"
...
#? Examples:
#?
#? bash filename_tagger.sh [TARGET DIRECTORY] 
#? bash filename_tagger.sh [TARGET DIRECTORY] text       # Use Cmd-line user-interface (80x24 min.).
#?                                            dialog     # Use Dialog   user-interface.
#?                                            whiptail   # Use Whiptail user-interface.
#?
#? bash filename_tagger.sh text       # Use Cmd-line user-interface (80x24 min.).
#?                         dialog     # Use Dialog   user-interface.
#?                         whiptail   # Use Whiptail user-interface.
#?
